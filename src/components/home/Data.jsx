...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Katarina Inezita
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
            ...
            <h3 className="home__subtitle">Data Scientist & Fullstack Web</h3>
            <p className="home__description">My genuine passion resides in the thrilling realms of Data Science, Machine Learning, and Website Development</p>
